...
#define LIBPATH "/data1/HB3/lib/"
#define LISTPATH "/data1/HB3/lists/"

#define BATHPATH "/data1/HB3/lib/etopo1_ice_gline.grd"
#define BATHPATH_C "/data1/HB3/lib/topo_tenthdeg_ice_gline.grd"

#define GAMMA_NC_PATH "/data1/HB3/lib/gamma.nc"
#define SHIPCODE_PATH "/data1/HB3/lib/wod_shipcodes.txt"

#define OI_PARMS_FILE "/data1/HB3/lib/global_oi_parms.nc"
